...
intms time_iccad20_cpu() {
  return 0 // timers["_build_prop_cands"]
    + timers["_build_rc_timing_tasks"]
    + timers["_update_timing__taskflow_rctiming"]
    + timers["_build_prop_tasks"]
    + timers["_update_timing__taskflow_prop"];
}
...
intms time_iccad20_gpu() {
  return 0 // timers["_build_prop_cands"]
    + timers["_build_rc_timing_tasks"]
    + timers["_update_timing__taskflow_rctiming"]
    + timers["bptc_memory_alloc"]
    + timers["build_tasks_prepare"]
    + timers["prop_prepare"]
    + timers["_build_prop_tasks_cuda"]
    + timers["_update_timing__taskflow_prop"];
}
